	...
	<article>
		...
		<div class="form-layout">
			<div class="form-box1">
				...
				<div class="field">
					<span>문의종류*</span>
						<input type="radio" name="radio1" class="rd"><span>사이트 이용</span>
						<input type="radio" name="radio1" class="rd"><span>회원/로그인</span>
						<input type="radio" name="radio1" class="rd"><span>환불/해지 신청</span>
						<input type="radio" name="radio1" class="rd"><span>이용권 결제</span>
						<input type="radio" name="radio1" class="rd"><span>장애신고</span>
						<input type="radio" name="radio1" class="rd"><span>콘텐츠/채널</span><br>
						<input type="radio" name="radio1" class="rd"><span>이벤트</span>
						<input type="radio" name="radio1" class="rd"><span>서비스 제한</span>
						<input type="radio" name="radio1"><span>기타</span>
				</div>
				<div class="field">
						<span>디바이스</span>&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<c:choose>
					<c:when test="${devicephoneList eq 'PC'}">
						<div class="field">
						<span>이용시간</span>&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<c:otherwise>
					<div class="field">
						<input type="radio" name="conenvironment"><span>와이파이</span>
						<input type="radio" name="conenvironment"><span>통신사(3G/4G/5G)</span>
					</div>
				...
				<input type="submit" value="문의 남기기" onClick="return inquiryCheck();" width="100">
			</form>
				</div>
			</div>
		</div>
